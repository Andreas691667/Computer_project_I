...
Again, we have divided it into the four main parts of the project described earlier. 
    ...
    \begin{enumerate}
        ...
        This was because the able should essentially maintain its path if possible. 
        ...
        Thus we chose to use power regression for the angular velocity as well. 
        ...
        \begin{table}[htbp]
            ...
            \hline
            \caption{Sample of a Table footnote.}
            \end{tabular}
