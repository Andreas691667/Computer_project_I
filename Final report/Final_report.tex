...
TXLED1; //LED turned off by default  \end{lstlisting}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{arduino_final.jpeg}
...
\section{References}
    \begin{itemize}
        ...
        \item Data sheet for Ultrasonic Range Finder: \emph{https://www.maxbotix.com/documents/LV-MaxSonar-EZ\_Datasheet.pdf}
    \end{itemize}
