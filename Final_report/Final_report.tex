...
\begin{minipage}{\linewidth} \begin{lstlisting}[style = my_python, caption = Case 1, basicstyle = \footnotesize]
...
\end{lstlisting} \end{minipage} 
    ...
    Afterwards we have the \textbf{think}-step in which we determine the best action to take. 
