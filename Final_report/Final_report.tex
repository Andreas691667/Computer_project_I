...
\section{Introduction}
    ...
    \begin{enumerate}
        ...
        \item ROS Programming on virtual machine. Learning the structure that ROS provides and going through the beginner's tutorial. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{lstlisting}[style = my_python, caption = Global variables, basicstyle = \footnotesize, label = lst:global_variables]
LINEAR_VEL = 0.22
STOP_DISTANCE = 0.2
LIDAR_ERROR = 0.05
SAFE_STOP_DISTANCE = STOP_DISTANCE + LIDAR_ERROR 
MAX_ANGLE = 2.84
DEFAULT_TURN_ANGLE = 3.14/2  \end{lstlisting}    
...
\begin{enumerate}
    \item Since we wanted the highest possible linear velocity, we set the default value of \texttt{LINEAR\_VEL} to \(0.22\), which is the maximum linear velocity of the turtlebot according to its documentation. 
...
Again, we have divided it into the four main parts of the project described earlier. 
    ...
    \begin{enumerate}
        ...
        \centering
            ...
            \begin{tabular}{|l|cll|}
            \hline
                                & \multicolumn{3}{c|}{\textbf{Distance}}                    \\ \hline
        ...
        In item \ref{subsec:calc_robot_performance} we are going to show calculations on the robot's performance for a number of different obstacle tracks.  
        ...
        \item \textbf{Calculations on the robot's performance}\label{subsec:calc_robot_performance} \\
    \end{enumerate}
...
\section{References}\label{sec:References}
    \begin{itemize}
        ...
        \item \href{http://wiki.ros.org/ROS/Tutorials}{ROS beginner's tutorial.}
        \item \href{https://let-elektronik.dk/shop/300-arduino-boards/12640-pro-micro---5v16mhz/}{Arduino PRO micro Specifications.}
        \item \href{https://let-elektronik.dk/shop/1440-afstand--bevaegelse/8502-ultrasonic-range-finder---lv-maxsonar-ez0/}{Data sheet and specifications for Ultrasonic Range Finder.}
        \item \href{https://let-elektronik.dk/shop/1450-lys--kamera/12829--rgb-light-sensor---isl29125/}{Data sheet and specifications for RGB light sensor.}
        \item \href{https://github.com/ROBOTIS-GIT/turtlebot3/blob/master/turtlebot3\_example/nodes/turtlebot3\_obstacle}{First robot navigation example from GitHub.}
        \item \href{https://emanual.robotis.com/docs/en/platform/turtlebot3/features/}{Turtlebot3 specifications.}
        \item \href{https://www.robotis.us/360-laser-distance-sensor-lds-01-lidar/}{LiDAR sensor specifications. }
    \end{itemize}
